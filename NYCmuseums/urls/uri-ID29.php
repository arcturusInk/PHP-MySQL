...
<html>
	...
	<?php
	$query = "SELECT website FROM moreInfo where infoID = 29";
	/* prepare statement */
	...
	<?php
	$query = "SELECT phone FROM moreInfo where infoID = 29";
	/* prepare statement */
	if ($stmt = $mysqli->prepare($query)) {
		$stmt->execute();
		/* bind variables to prepared statement */
	...
	<?php
	$query = "SELECT hours FROM moreInfo where infoID = 29";
	/* prepare statement */
	if ($stmt = $mysqli->prepare($query)) {
		$stmt->execute();
		/* bind variables to prepared statement */
	...
	<?php
	$query = "SELECT admissions FROM moreInfo where infoID = 29";
	/* prepare statement */
	if ($stmt = $mysqli->prepare($query)) {
		$stmt->execute();
		/* bind variables to prepared statement */
